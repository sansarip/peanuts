...
(defn init-state [state]
  (assoc-in state [:cljs.analyzer/namespaces 'peanuts.core]
            (analyzer-state 'peanuts.core)))

#_
(defn load-library-analysis-cache! []
  (cljs.js/load-analysis-cache! state 'peanuts.core (analyzer-state 'peanuts.core))
  nil)
