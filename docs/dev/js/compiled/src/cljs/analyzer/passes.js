...
return cljs.core.into.call(null,cljs.core.PersistentVector.EMPTY,cljs.core.map.call(null,(function (p1__9847_SHARP_){
return cljs.analyzer.passes.walk.call(null,p1__9847_SHARP_,passes,opts);
})),child);
} else {
return cljs.analyzer.passes.walk.call(null,child,passes,opts);
}
})());
}),(function (){var G__9850 = ast;
if((G__9850 == null)){
return null;
} else {
return cljs.analyzer.passes.apply_passes.call(null,G__9850,passes,opts);
}
