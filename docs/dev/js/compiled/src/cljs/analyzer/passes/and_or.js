...
cljs.analyzer.passes.and_or.simple_test_expr_QMARK_ = (function cljs$analyzer$passes$and_or$simple_test_expr_QMARK_(p__9854){
var map__9855 = p__9854;
var map__9855__$1 = cljs.core.__destructure_map.call(null,map__9855);
var ast = map__9855__$1;
var op = cljs.core.get.call(null,map__9855__$1,new cljs.core.Keyword(null,"op","op",-1882987955));
return cljs.core.boolean$.call(null,(function (){var and__4221__auto__ = cljs.analyzer.passes.and_or.simple_op_QMARK_.call(null,ast);
if(and__4221__auto__){
return new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Symbol(null,"seq","seq",-177272256,null),"null",new cljs.core.Symbol(null,"boolean","boolean",-278886877,null),"null"], null), null).call(null,(function (){var or__4223__auto__ = new cljs.core.Keyword(null,"tag","tag",-1290361223).cljs$core$IFn$_invoke$arity$1(ast);
...
return cljs.core.remove.call(null,(function (p1__9856_SHARP_){
return cljs.core._EQ_.call(null,local,new cljs.core.Keyword(null,"name","name",1843675177).cljs$core$IFn$_invoke$arity$1(p1__9856_SHARP_));
}),xs);
}));
}),loop_lets);
}));
...
var G__9857 = cljs.core.update_in.call(null,ast,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"env","env",-1815813235),new cljs.core.Keyword(null,"locals","locals",535295783)], null),cljs.core.dissoc,local);
...
return cljs.analyzer.passes.and_or.remove_loop_let.call(null,G__9857,local);
} else {
return G__9857;
}
});
...
var map__9858 = cljs.core.first.call(null,new cljs.core.Keyword(null,"bindings","bindings",1271397192).cljs$core$IFn$_invoke$arity$1(ast));
var map__9858__$1 = cljs.core.__destructure_map.call(null,map__9858);
var init = cljs.core.get.call(null,map__9858__$1,new cljs.core.Keyword(null,"init","init",-1875481434));
...
var map__9859 = cljs.core.first.call(null,new cljs.core.Keyword(null,"bindings","bindings",1271397192).cljs$core$IFn$_invoke$arity$1(ast));
var map__9859__$1 = cljs.core.__destructure_map.call(null,map__9859);
var init = cljs.core.get.call(null,map__9859__$1,new cljs.core.Keyword(null,"init","init",-1875481434));
var name = cljs.core.get.call(null,map__9859__$1,new cljs.core.Keyword(null,"name","name",1843675177));
