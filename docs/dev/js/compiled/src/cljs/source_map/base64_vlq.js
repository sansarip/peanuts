...
var digit_11174 = (vlq & cljs.source_map.base64_vlq.vlq_base_mask);
var vlq_11175__$1 = (vlq >>> (5));
while(true){
if((vlq_11175__$1 > (0))){
var digit_11176__$1 = (digit_11174 | cljs.source_map.base64_vlq.vlq_continuation_bit);
sb.append(cljs.source_map.base64.encode.call(null,digit_11176__$1));

var G__11177 = (vlq_11175__$1 & cljs.source_map.base64_vlq.vlq_base_mask);
var G__11178 = (vlq_11175__$1 >>> (5));
digit_11174 = G__11177;
vlq_11175__$1 = G__11178;
continue;
} else {
sb.append(cljs.source_map.base64.encode.call(null,digit_11174));
}
break;
}
...
var G__11179 = i__$1;
var G__11180 = result__$1;
var G__11181 = shift__$1;
i = G__11179;
result = G__11180;
shift = G__11181;
continue;
