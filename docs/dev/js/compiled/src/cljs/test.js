...
var G__23270 = new cljs.core.PersistentArrayMap(null, 5, [new cljs.core.Keyword(null,"report-counters","report-counters",-1702609242),new cljs.core.PersistentArrayMap(null, 4, [new cljs.core.Keyword(null,"test","test",577538877),(0),new cljs.core.Keyword(null,"pass","pass",1574159993),(0),new cljs.core.Keyword(null,"fail","fail",1706214930),(0),new cljs.core.Keyword(null,"error","error",-978969032),(0)], null),new cljs.core.Keyword(null,"testing-vars","testing-vars",-2114769150),cljs.core.List.EMPTY,new cljs.core.Keyword(null,"testing-contexts","testing-contexts",-1485646523),cljs.core.List.EMPTY,new cljs.core.Keyword(null,"formatter","formatter",-483008823),cljs.core.pr_str,new cljs.core.Keyword(null,"reporter","reporter",-805360621),reporter], null);
if(cljs.core._EQ_.call(null,new cljs.core.Keyword("cljs.test","pprint","cljs.test/pprint",1627393641),reporter)){
return cljs.core.assoc.call(null,G__23270,new cljs.core.Keyword(null,"reporter","reporter",-805360621),new cljs.core.Keyword("cljs.test","default","cljs.test/default",-1581405322),new cljs.core.Keyword(null,"formatter","formatter",-483008823),cljs.pprint.pprint);
} else {
return G__23270;
}
}));
...
var or__4223__auto__ = cljs.test._STAR_current_env_STAR_;
...
var len__4829__auto___23275 = arguments.length;
var i__4830__auto___23276 = (0);
while(true){
if((i__4830__auto___23276 < len__4829__auto___23275)){
args__4835__auto__.push((arguments[i__4830__auto___23276]));

var G__23277 = (i__4830__auto___23276 + (1));
i__4830__auto___23276 = G__23277;
continue;
} else {
}
break;
...
return cljs.test.update_current_env_BANG_.cljs$core$IFn$_invoke$arity$variadic((arguments[(0)]),(arguments[(1)]),argseq__4836__auto__);
});
...
/** @this {Function} */
(cljs.test.update_current_env_BANG_.cljs$lang$applyTo = (function (seq23272){
var G__23273 = cljs.core.first.call(null,seq23272);
var seq23272__$1 = cljs.core.next.call(null,seq23272);
var G__23274 = cljs.core.first.call(null,seq23272__$1);
var seq23272__$2 = cljs.core.next.call(null,seq23272__$1);
var self__4816__auto__ = this;
return self__4816__auto__.cljs$core$IFn$_invoke$arity$variadic(G__23273,G__23274,seq23272__$2);
}));
...
var map__23279 = m;
var map__23279__$1 = cljs.core.__destructure_map.call(null,map__23279);
var file = cljs.core.get.call(null,map__23279__$1,new cljs.core.Keyword(null,"file","file",-1269645878));
var line = cljs.core.get.call(null,map__23279__$1,new cljs.core.Keyword(null,"line","line",212345235));
var column = cljs.core.get.call(null,map__23279__$1,new cljs.core.Keyword(null,"column","column",2078222095));
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1(cljs.core.reverse.call(null,cljs.core.map.call(null,(function (p1__23278_SHARP_){
return new cljs.core.Keyword(null,"name","name",1843675177).cljs$core$IFn$_invoke$arity$1(cljs.core.meta.call(null,p1__23278_SHARP_));
 ...
 */
cljs.test.report = (function (){var method_table__4712__auto__ = cljs.core.atom.call(null,cljs.core.PersistentArrayMap.EMPTY);
...
var formatter_fn = (function (){var or__4223__auto__ = new cljs.core.Keyword(null,"formatter","formatter",-483008823).cljs$core$IFn$_invoke$arity$1(cljs.test.get_current_env.call(null));
if(cljs.core.truth_(or__4223__auto__)){
return or__4223__auto__;
} else {
...
var temp__5720__auto___23280 = new cljs.core.Keyword(null,"message","message",-406056002).cljs$core$IFn$_invoke$arity$1(m);
if(cljs.core.truth_(temp__5720__auto___23280)){
var message_23281 = temp__5720__auto___23280;
cljs.core.println.call(null,message_23281);
} else {
}
...
var temp__5720__auto___23282 = new cljs.core.Keyword(null,"message","message",-406056002).cljs$core$IFn$_invoke$arity$1(m);
if(cljs.core.truth_(temp__5720__auto___23282)){
var message_23283 = temp__5720__auto___23282;
cljs.core.println.call(null,message_23283);
} else {
}
...
var output_dir = "resources/public/dev/js/compiled/src";
var output_dir__$1 = (function (){var G__23284 = output_dir;
if((!(clojure.string.ends_with_QMARK_.call(null,output_dir,"/")))){
return [G__23284,"/"].join('');
} else {
return G__23284;
}
})();
...
var temp__5718__auto__ = (function (){var and__4221__auto__ = typeof exception.stack === 'string';
if(and__4221__auto__){
var G__23285 = exception.stack;
var G__23285__$1 = (((G__23285 == null))?null:clojure.string.split_lines.call(null,G__23285));
var G__23285__$2 = (((G__23285__$1 == null))?null:cljs.core.get.call(null,G__23285__$1,depth));
if((G__23285__$2 == null)){
return null;
} else {
return clojure.string.trim.call(null,G__23285__$2);
}
} else {
...
var vec__23286 = cljs.test.js_line_and_column.call(null,stack_element);
var line = cljs.core.nth.call(null,vec__23286,(0),null);
var column = cljs.core.nth.call(null,vec__23286,(1),null);
var vec__23289 = cljs.test.mapped_line_and_column.call(null,fname,line,column);
var fname__$1 = cljs.core.nth.call(null,vec__23289,(0),null);
var line__$1 = cljs.core.nth.call(null,vec__23289,(1),null);
var column__$1 = cljs.core.nth.call(null,vec__23289,(2),null);
...
var m__$1 = (function (){var G__23292 = new cljs.core.Keyword(null,"type","type",1174270348).cljs$core$IFn$_invoke$arity$1(m);
...
var G__23296 = (function (){var G__23295 = cljs.core.rest.call(null,fns);
...
return cljs.core.concat.call(null,obj,G__23295);
} else {
return G__23295;
}
})();
...
return cljs.core.vary_meta.call(null,G__23297,cljs.core.assoc,new cljs.core.Keyword("cljs.test","block?","cljs.test/block?",686379965),true);
}
});
...
var vec__23301 = fixtures_types.call(null);
var type = cljs.core.nth.call(null,vec__23301,(0),null);
var types = vec__23301;
...
return cljs.core.map.call(null,(function (p__23304){
var vec__23305 = p__23304;
var ns = cljs.core.nth.call(null,vec__23305,(0),null);
var vars__$1 = cljs.core.nth.call(null,vec__23305,(1),null);
return (function (){
...
var G__23308 = cljs.test.execution_strategy.call(null,once_fixtures,each_fixtures);
...
var seq__23309 = cljs.core.seq.call(null,vars__$1);
var chunk__23310 = null;
var count__23311 = (0);
var i__23312 = (0);
while(true){
if((i__23312 < count__23311)){
var v = cljs.core._nth.call(null,chunk__23310,i__23312);
var temp__5720__auto___23314 = new cljs.core.Keyword(null,"test","test",577538877).cljs$core$IFn$_invoke$arity$1(cljs.core.meta.call(null,v));
if(cljs.core.truth_(temp__5720__auto___23314)){
var t_23315 = temp__5720__auto___23314;
each_fixture_fn.call(null,((function (seq__23309,chunk__23310,count__23311,i__23312,t_23315,temp__5720__auto___23314,v,each_fixture_fn,G__23308,G__23308__$1,env,once_fixtures,each_fixtures,vec__23305,ns,vars__$1){
return (function (){
return cljs.test.run_block.call(null,cljs.test.test_var_block_STAR_.call(null,v,cljs.test.disable_async.call(null,t_23315)));
});})(seq__23309,chunk__23310,count__23311,i__23312,t_23315,temp__5720__auto___23314,v,each_fixture_fn,G__23308,G__23308__$1,env,once_fixtures,each_fixtures,vec__23305,ns,vars__$1))
);
} else {
}


var G__23316 = seq__23309;
var G__23317 = chunk__23310;
var G__23318 = count__23311;
var G__23319 = (i__23312 + (1));
seq__23309 = G__23316;
chunk__23310 = G__23317;
count__23311 = G__23318;
i__23312 = G__23319;
continue;
} else {
var temp__5720__auto__ = cljs.core.seq.call(null,seq__23309);
if(temp__5720__auto__){
var seq__23309__$1 = temp__5720__auto__;
if(cljs.core.chunked_seq_QMARK_.call(null,seq__23309__$1)){
var c__4649__auto__ = cljs.core.chunk_first.call(null,seq__23309__$1);
var G__23320 = cljs.core.chunk_rest.call(null,seq__23309__$1);
var G__23321 = c__4649__auto__;
var G__23322 = cljs.core.count.call(null,c__4649__auto__);
var G__23323 = (0);
seq__23309 = G__23320;
chunk__23310 = G__23321;
count__23311 = G__23322;
i__23312 = G__23323;
continue;
} else {
var v = cljs.core.first.call(null,seq__23309__$1);
var temp__5720__auto___23324__$1 = new cljs.core.Keyword(null,"test","test",577538877).cljs$core$IFn$_invoke$arity$1(cljs.core.meta.call(null,v));
if(cljs.core.truth_(temp__5720__auto___23324__$1)){
var t_23325 = temp__5720__auto___23324__$1;
each_fixture_fn.call(null,((function (seq__23309,chunk__23310,count__23311,i__23312,t_23325,temp__5720__auto___23324__$1,v,seq__23309__$1,temp__5720__auto__,each_fixture_fn,G__23308,G__23308__$1,env,once_fixtures,each_fixtures,vec__23305,ns,vars__$1){
return (function (){
return cljs.test.run_block.call(null,cljs.test.test_var_block_STAR_.call(null,v,cljs.test.disable_async.call(null,t_23325)));
});})(seq__23309,chunk__23310,count__23311,i__23312,t_23325,temp__5720__auto___23324__$1,v,seq__23309__$1,temp__5720__auto__,each_fixture_fn,G__23308,G__23308__$1,env,once_fixtures,each_fixtures,vec__23305,ns,vars__$1))
);
} else {
}


var G__23326 = cljs.core.next.call(null,seq__23309__$1);
var G__23327 = null;
var G__23328 = (0);
var G__23329 = (0);
seq__23309 = G__23326;
chunk__23310 = G__23327;
count__23311 = G__23328;
i__23312 = G__23329;
continue;
}
} else {
...
break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__23308__$1)].join('')));
