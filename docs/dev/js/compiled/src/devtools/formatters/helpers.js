...
var G__27795 = devtools.prefs.pref.call(null,v);
v = G__27795;
continue;
} else {
return v;
...
}catch (e27796){var _e__27078__auto__ = e27796;
return false;
}})();
...
}catch (e27798){var _e__27078__auto__ = e27798;
return false;
}})();
...
}catch (e27800){var _e__27078__auto__ = e27800;
return false;
}}
}
});
...
var vec__27802 = devtools.munging.parse_constructor_info.call(null,constructor_fn);
var ns = cljs.core.nth.call(null,vec__27802,(0),null);
var name = cljs.core.nth.call(null,vec__27802,(1),null);
...
return cljs.core.some.call(null,(function (p1__27805_SHARP_){
return cljs.core._EQ_.call(null,devtools.formatters.helpers.pref.call(null,new cljs.core.Keyword(null,"more-marker","more-marker",-14717935)),p1__27805_SHARP_);
}),template);
});
