...
var map__28951 = top_item;
var map__28951__$1 = cljs.core.__destructure_map.call(null,map__28951);
var file = cljs.core.get.call(null,map__28951__$1,new cljs.core.Keyword(null,"file","file",-1269645878));
var line = cljs.core.get.call(null,map__28951__$1,new cljs.core.Keyword(null,"line","line",212345235));
var column = cljs.core.get.call(null,map__28951__$1,new cljs.core.Keyword(null,"column","column",2078222095));
return devtools.hints.make_sense_of_the_error.call(null,error.message,file,line,column);
}catch (e28950){var _e = e28950;
return false;
}});
devtools.hints.type_error_to_string = (function devtools$hints$type_error_to_string(self){
var temp__5718__auto___28952 = devtools.hints.get_processed_errors_BANG_.call(null);
if(cljs.core.truth_(temp__5718__auto___28952)){
var seen_errors_28953 = temp__5718__auto___28952;
if(cljs.core.truth_(seen_errors_28953.has(self))){
} else {
seen_errors_28953.add(self);

var temp__5720__auto___28954 = devtools.hints.error_object_sense.call(null,self);
if(cljs.core.truth_(temp__5720__auto___28954)){
var sense_28955 = temp__5720__auto___28954;
(self.message = [cljs.core.str.cljs$core$IFn$_invoke$arity$1(self.message),", a sanity hint:\n",cljs.core.str.cljs$core$IFn$_invoke$arity$1(sense_28955)].join(''));
} else {
}
}
} else {
