...
var o27691 = temp__5718__auto__;
var temp__5718__auto____$1 = (o27691["core"]);
if(cljs.core.truth_(temp__5718__auto____$1)){
var o27692 = temp__5718__auto____$1;
return (o27692["js_reserved_QMARK_"]);
} else {
return null;
}
} else {
...
var o__27071__auto__ = f;
return (o__27071__auto__["toString"]).call(o__27071__auto__);
} else {
return "";
}
}catch (e27693){var _ = e27693;
return "";
}});
...
try{var o__27071__auto___27695 = t;
(o__27071__auto___27695["cljs$lang$ctorPrWriter"]).call(o__27071__auto___27695,t,writer);
}catch (e27694){var __27696 = e27694;
}
...
var char_code = (function (){var o__27071__auto__ = (new String(char$));
return (o__27071__auto__["charCodeAt"]).call(o__27071__auto__,(0));
})();
var num_code = (char_code - (48));
var subscript_code = ((8320) + num_code);
var o__27071__auto__ = String;
return (o__27071__auto__["fromCharCode"]).call(o__27071__auto__,subscript_code);
});
/**
...
var num_code = (char_code - (48));
var superscript_code = (function (){var G__27697 = num_code;
switch (G__27697) {
case (1):
return (185);
...
var o__27071__auto__ = String;
return (o__27071__auto__["fromCharCode"]).call(o__27071__auto__,superscript_code);
});
/**
...
}catch (e27699){var _e__27078__auto__ = e27699;
return false;
}})())){
...
var vec__27700 = devtools.munging.parse_fn_source.call(null,fn_source);
var name__$1 = cljs.core.nth.call(null,vec__27700,(0),null);
...
var or__4223__auto__ = (function (){var temp__5718__auto__ = cljs.core.re_matches.call(null,/(.*)\$/,s);
if(cljs.core.truth_(temp__5718__auto__)){
...
if(cljs.core.truth_(temp__5718__auto__)){
var o27703 = temp__5718__auto__;
var temp__5718__auto____$1 = (o27703["dependencies_"]);
if(cljs.core.truth_(temp__5718__auto____$1)){
var o27704 = temp__5718__auto____$1;
return (o27704["nameToPath"]);
} else {
return null;
}
} else {
...
var len__4829__auto___27711 = arguments.length;
var i__4830__auto___27712 = (0);
while(true){
if((i__4830__auto___27712 < len__4829__auto___27711)){
args__4835__auto__.push((arguments[i__4830__auto___27712]));

var G__27713 = (i__4830__auto___27712 + (1));
i__4830__auto___27712 = G__27713;
continue;
} else {
}
break;
...
(devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic = (function (tokens,p__27707){
var vec__27708 = p__27707;
var ns_detector = cljs.core.nth.call(null,vec__27708,(0),null);
...
var G__27714 = cljs.core.concat.call(null,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.last.call(null,remaining_tokens)], null),name_tokens);
var G__27715 = cljs.core.butlast.call(null,remaining_tokens);
name_tokens = G__27714;
remaining_tokens = G__27715;
continue;
}
}
break;
...
/** @this {Function} */
(devtools.munging.detect_namespace_prefix.cljs$lang$applyTo = (function (seq27705){
var G__27706 = cljs.core.first.call(null,seq27705);
var seq27705__$1 = cljs.core.next.call(null,seq27705);
var self__4816__auto__ = this;
return self__4816__auto__.cljs$core$IFn$_invoke$arity$variadic(G__27706,seq27705__$1);
}));
...
var vec__27719 = cljs.core.split_with.call(null,(function (p1__27718_SHARP_){
return cljs.core.not_EQ_.call(null,p1__27718_SHARP_,"arity");
}),tokens);
var prefix_tokens = cljs.core.nth.call(null,vec__27719,(0),null);
var arity_tokens = cljs.core.nth.call(null,vec__27719,(1),null);
...
var vec__27725 = devtools.munging.detect_namespace_prefix.call(null,remaining_tokens,detector);
var protocol_ns = cljs.core.nth.call(null,vec__27725,(0),null);
var name_and_method_tokens = cljs.core.nth.call(null,vec__27725,(1),null);
if(cljs.core.empty_QMARK_.call(null,protocol_ns)){
var G__27728 = cljs.core.rest.call(null,remaining_tokens);
var G__27729 = cljs.core.conj.call(null,name_tokens,cljs.core.first.call(null,remaining_tokens));
remaining_tokens = G__27728;
name_tokens = G__27729;
continue;
} else {
...
var vec__27732 = devtools.munging.strip_arity.call(null,tokens);
var tokens__$1 = cljs.core.nth.call(null,vec__27732,(0),null);
var arity = cljs.core.nth.call(null,vec__27732,(1),null);
var vec__27735 = devtools.munging.detect_namespace_prefix.call(null,tokens__$1,effective_detector);
var fn_ns = cljs.core.nth.call(null,vec__27735,(0),null);
var tokens__$2 = cljs.core.nth.call(null,vec__27735,(1),null);
var vec__27738 = devtools.munging.parse_protocol.call(null,tokens__$2,effective_detector);
var fn_name_tokens = cljs.core.nth.call(null,vec__27738,(0),null);
var protocol_ns = cljs.core.nth.call(null,vec__27738,(1),null);
var protocol_name = cljs.core.nth.call(null,vec__27738,(2),null);
var protocol_method_tokens = cljs.core.nth.call(null,vec__27738,(3),null);
...
var munged_ns = cljs.core.nth.call(null,vec__27744,(0),null);
var munged_name__$1 = cljs.core.nth.call(null,vec__27744,(1),null);
var munged_protocol_ns = cljs.core.nth.call(null,vec__27744,(2),null);
var munged_protocol_name = cljs.core.nth.call(null,vec__27744,(3),null);
var munged_protocol_method = cljs.core.nth.call(null,vec__27744,(4),null);
var arity = cljs.core.nth.call(null,vec__27744,(5),null);
...
if(cljs.core.truth_(temp__5718__auto__)){
var vec__27748 = temp__5718__auto__;
var munged_name = cljs.core.nth.call(null,vec__27748,(0),null);
var args = cljs.core.nth.call(null,vec__27748,(1),null);
var vec__27751 = devtools.munging.break_and_demunge_name.call(null,munged_name);
var ns = cljs.core.nth.call(null,vec__27751,(0),null);
var name = cljs.core.nth.call(null,vec__27751,(1),null);
...
var G__27754 = (arity + (1));
var G__27755 = (function (){var temp__5718__auto__ = devtools.munging.get_fn_fixed_arity.call(null,f,arity);
if(cljs.core.truth_(temp__5718__auto__)){
...
devtools.munging.review_arity = (function devtools$munging$review_arity(p__27756){
var vec__27757 = p__27756;
var arity = cljs.core.nth.call(null,vec__27757,(0),null);
var arity_fn = cljs.core.nth.call(null,vec__27757,(1),null);
...
var sorted_fns = cljs.core.map.call(null,(function (p1__27760_SHARP_){
return cljs.core.get.call(null,arities,p1__27760_SHARP_);
}),sorted_keys);
var sorted_infos = cljs.core.map.call(null,devtools.munging.parse_fn_info_deep,sorted_fns);
var sorted_args_lists = cljs.core.map.call(null,(function (p1__27761_SHARP_){
return cljs.core.drop.call(null,(2),p1__27761_SHARP_);
}),sorted_infos);
...
var args__4835__auto__ = [];
var len__4829__auto___27768 = arguments.length;
var i__4830__auto___27769 = (0);
while(true){
if((i__4830__auto___27769 < len__4829__auto___27768)){
args__4835__auto__.push((arguments[i__4830__auto___27769]));

var G__27770 = (i__4830__auto___27769 + (1));
i__4830__auto___27769 = G__27770;
continue;
} else {
}
break;
...
(devtools.munging.arities_to_args_lists.cljs$core$IFn$_invoke$arity$variadic = (function (arities,p__27764){
var vec__27765 = p__27764;
var humanize_QMARK_ = cljs.core.nth.call(null,vec__27765,(0),null);
...
/** @this {Function} */
(devtools.munging.arities_to_args_lists.cljs$lang$applyTo = (function (seq27762){
var G__27763 = cljs.core.first.call(null,seq27762);
var seq27762__$1 = cljs.core.next.call(null,seq27762);
var self__4816__auto__ = this;
return self__4816__auto__.cljs$core$IFn$_invoke$arity$variadic(G__27763,seq27762__$1);
}));
...
var map__27773 = options;
var map__27773__$1 = cljs.core.__destructure_map.call(null,map__27773);
var include_ns_QMARK_ = cljs.core.get.call(null,map__27773__$1,new cljs.core.Keyword(null,"include-ns?","include-ns?",-341372810));
var include_protocol_ns_QMARK_ = cljs.core.get.call(null,map__27773__$1,new cljs.core.Keyword(null,"include-protocol-ns?","include-protocol-ns?",989250951));
var silence_common_protocols_QMARK_ = cljs.core.get.call(null,map__27773__$1,new cljs.core.Keyword(null,"silence-common-protocols?","silence-common-protocols?",2012431893));
var ns_detector = cljs.core.get.call(null,map__27773__$1,new cljs.core.Keyword(null,"ns-detector","ns-detector",-2041592760));
var vec__27774 = devtools.munging.break_and_demunge_name.call(null,munged_name,ns_detector);
var fn_ns = cljs.core.nth.call(null,vec__27774,(0),null);
var fn_name = cljs.core.nth.call(null,vec__27774,(1),null);
var protocol_ns = cljs.core.nth.call(null,vec__27774,(2),null);
var protocol_name = cljs.core.nth.call(null,vec__27774,(3),null);
var protocol_method = cljs.core.nth.call(null,vec__27774,(4),null);
var arity = cljs.core.nth.call(null,vec__27774,(5),null);
...
var o__27071__auto__ = f;
return (o__27071__auto__["getBasis"]).call(o__27071__auto__);
});
/**
...
}catch (e27777){var _e__27078__auto__ = e27777;
...
var G__27778 = (obj[cljs.core.first.call(null,path)]);
var G__27779 = cljs.core.rest.call(null,path);
obj = G__27778;
path = G__27779;
continue;
} else {
...
var _STAR_ = (function (accum,p__27780){
var vec__27781 = p__27780;
var bit = cljs.core.nth.call(null,vec__27781,(0),null);
var protocol = cljs.core.nth.call(null,vec__27781,(1),null);
...
devtools.munging.convert_to_protocol_descriptor = (function devtools$munging$convert_to_protocol_descriptor(fast_QMARK_,p__27784){
var vec__27785 = p__27784;
var ns = cljs.core.nth.call(null,vec__27785,(0),null);
var name = cljs.core.nth.call(null,vec__27785,(1),null);
var selector = cljs.core.nth.call(null,vec__27785,(2),null);
...
var post_process = (function (p__27789){
var vec__27790 = p__27789;
var munged_name = cljs.core.nth.call(null,vec__27790,(0),null);
var matches__$1 = cljs.core.nth.call(null,vec__27790,(1),null);
...
var sorted_fns = cljs.core.map.call(null,(function (p1__27788_SHARP_){
return (obj[cljs.core.first.call(null,p1__27788_SHARP_)]);
}),sorted_matches);
