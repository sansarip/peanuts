...
try{return cljs.core.reduce.call(null,cljs.core._PLUS_,cljs.core.map.call(null,cljs.core._STAR_,new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [(100000000000),(10000),(1)], null),cljs.core.map.call(null,(function (p1__28327_SHARP_){
return parseInt(p1__28327_SHARP_);
}),cljs.core.take.call(null,(3),clojure.string.split.call(null,v,/[^\d]/)))));
}catch (e28328){if((e28328 instanceof Error)){
var e = e28328;
...
var c_28330 = (new goog.debug.Console());
var G__28329_28331 = c_28330.getFormatter();
goog.object.set(G__28329_28331,"showAbsoluteTime",false);

goog.object.set(G__28329_28331,"showRelativeTime",false);


goog.object.set(goog.debug.Console,"instance",c_28330);
...
figwheel.repl.logging.log_levels = cljs.core.into.call(null,cljs.core.PersistentArrayMap.EMPTY,cljs.core.map.call(null,cljs.core.juxt.call(null,clojure.string.lower_case,(function (p1__28332_SHARP_){
return goog.object.get(goog.debug.Logger.Level,p1__28332_SHARP_);
