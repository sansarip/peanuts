 ...
 */
garden.compression.token_fn = (function garden$compression$token_fn(p__24149){
var vec__24150 = p__24149;
var tag = cljs.core.nth.call(null,vec__24150,(0),null);
var re = cljs.core.nth.call(null,vec__24150,(1),null);
return (function (s){
...
var len__4829__auto___24155 = arguments.length;
var i__4830__auto___24156 = (0);
while(true){
if((i__4830__auto___24156 < len__4829__auto___24155)){
args__4835__auto__.push((arguments[i__4830__auto___24156]));

var G__24157 = (i__4830__auto___24156 + (1));
i__4830__auto___24156 = G__24157;
continue;
} else {
}
break;
...
return garden.compression.tokenizer.cljs$core$IFn$_invoke$arity$variadic(argseq__4836__auto__);
});
...
return (function (s){
return cljs.core.some.call(null,(function (p1__24153_SHARP_){
return p1__24153_SHARP_.call(null,s);
}),fs);
});
}));
...
/** @this {Function} */
(garden.compression.tokenizer.cljs$lang$applyTo = (function (seq24154){
var self__4817__auto__ = this;
return self__4817__auto__.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq.call(null,seq24154));
}));
...
var map__24158 = temp__5718__auto__;
var map__24158__$1 = cljs.core.__destructure_map.call(null,map__24158);
var tag = cljs.core.get.call(null,map__24158__$1,new cljs.core.Keyword(null,"tag","tag",-1290361223));
var chunk = cljs.core.get.call(null,map__24158__$1,new cljs.core.Keyword(null,"chunk","chunk",-1191159620));
var size = cljs.core.get.call(null,map__24158__$1,new cljs.core.Keyword(null,"size","size",1098693007));
var G__24161 = cljs.core.subs.call(null,s1,size);
var G__24162 = [s2,cljs.core.str.cljs$core$IFn$_invoke$arity$1((function (){var G__24160 = tag;
