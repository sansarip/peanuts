...
return [(function (){var pred__9562 = cljs.core.instance_QMARK_;
var expr__9563 = reactive_val;
if(cljs.core.truth_(pred__9562.call(null,reagent.ratom.RAtom,expr__9563))){
return "ra";
} else {
if(cljs.core.truth_(pred__9562.call(null,reagent.ratom.RCursor,expr__9563))){
return "rc";
} else {
if(cljs.core.truth_(pred__9562.call(null,reagent.ratom.Reaction,expr__9563))){
return "rx";
} else {
if(cljs.core.truth_(pred__9562.call(null,reagent.ratom.Track,expr__9563))){
return "tr";
} else {
return "other";
}
