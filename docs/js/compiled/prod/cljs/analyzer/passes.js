...
return cljs.core.into.call(null,cljs.core.PersistentVector.EMPTY,cljs.core.map.call(null,(function (p1__12557_SHARP_){
return cljs.analyzer.passes.walk.call(null,p1__12557_SHARP_,passes,opts);
})),child);
} else {
return cljs.analyzer.passes.walk.call(null,child,passes,opts);
}
})());
}),(function (){var G__12560 = ast;
if((G__12560 == null)){
return null;
} else {
return cljs.analyzer.passes.apply_passes.call(null,G__12560,passes,opts);
}
