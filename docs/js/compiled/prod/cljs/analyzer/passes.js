...
return cljs.core.into.call(null,cljs.core.PersistentVector.EMPTY,cljs.core.map.call(null,(function (p1__13175_SHARP_){
return cljs.analyzer.passes.walk.call(null,p1__13175_SHARP_,passes,opts);
})),child);
} else {
return cljs.analyzer.passes.walk.call(null,child,passes,opts);
}
})());
}),(function (){var G__13178 = ast;
if((G__13178 == null)){
return null;
} else {
return cljs.analyzer.passes.apply_passes.call(null,G__13178,passes,opts);
}
