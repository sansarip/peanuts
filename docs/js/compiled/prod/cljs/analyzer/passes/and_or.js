...
cljs.analyzer.passes.and_or.simple_test_expr_QMARK_ = (function cljs$analyzer$passes$and_or$simple_test_expr_QMARK_(p__13182){
var map__13183 = p__13182;
var map__13183__$1 = cljs.core.__destructure_map.call(null,map__13183);
var ast = map__13183__$1;
var op = cljs.core.get.call(null,map__13183__$1,new cljs.core.Keyword(null,"op","op",-1882987955));
...
return cljs.core.remove.call(null,(function (p1__13184_SHARP_){
return cljs.core._EQ_.call(null,local,new cljs.core.Keyword(null,"name","name",1843675177).cljs$core$IFn$_invoke$arity$1(p1__13184_SHARP_));
}),xs);
}));
}),loop_lets);
}));
...
var G__13185 = cljs.core.update_in.call(null,ast,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"env","env",-1815813235),new cljs.core.Keyword(null,"locals","locals",535295783)], null),cljs.core.dissoc,local);
...
return cljs.analyzer.passes.and_or.remove_loop_let.call(null,G__13185,local);
} else {
return G__13185;
}
});
...
var map__13186 = cljs.core.first.call(null,new cljs.core.Keyword(null,"bindings","bindings",1271397192).cljs$core$IFn$_invoke$arity$1(ast));
var map__13186__$1 = cljs.core.__destructure_map.call(null,map__13186);
var init = cljs.core.get.call(null,map__13186__$1,new cljs.core.Keyword(null,"init","init",-1875481434));
...
var map__13187 = cljs.core.first.call(null,new cljs.core.Keyword(null,"bindings","bindings",1271397192).cljs$core$IFn$_invoke$arity$1(ast));
var map__13187__$1 = cljs.core.__destructure_map.call(null,map__13187);
var init = cljs.core.get.call(null,map__13187__$1,new cljs.core.Keyword(null,"init","init",-1875481434));
