...
var G__26228 = new cljs.core.PersistentArrayMap(null, 5, [new cljs.core.Keyword(null,"report-counters","report-counters",-1702609242),new cljs.core.PersistentArrayMap(null, 4, [new cljs.core.Keyword(null,"test","test",577538877),(0),new cljs.core.Keyword(null,"pass","pass",1574159993),(0),new cljs.core.Keyword(null,"fail","fail",1706214930),(0),new cljs.core.Keyword(null,"error","error",-978969032),(0)], null),new cljs.core.Keyword(null,"testing-vars","testing-vars",-2114769150),cljs.core.List.EMPTY,new cljs.core.Keyword(null,"testing-contexts","testing-contexts",-1485646523),cljs.core.List.EMPTY,new cljs.core.Keyword(null,"formatter","formatter",-483008823),cljs.core.pr_str,new cljs.core.Keyword(null,"reporter","reporter",-805360621),reporter], null);
if(cljs.core._EQ_.call(null,new cljs.core.Keyword("cljs.test","pprint","cljs.test/pprint",1627393641),reporter)){
return cljs.core.assoc.call(null,G__26228,new cljs.core.Keyword(null,"reporter","reporter",-805360621),new cljs.core.Keyword("cljs.test","default","cljs.test/default",-1581405322),new cljs.core.Keyword(null,"formatter","formatter",-483008823),cljs.pprint.pprint);
} else {
return G__26228;
}
}));
...
var len__4829__auto___26233 = arguments.length;
var i__4830__auto___26234 = (0);
while(true){
if((i__4830__auto___26234 < len__4829__auto___26233)){
args__4835__auto__.push((arguments[i__4830__auto___26234]));

var G__26235 = (i__4830__auto___26234 + (1));
i__4830__auto___26234 = G__26235;
continue;
} else {
}
break;
...
/** @this {Function} */
(cljs.test.update_current_env_BANG_.cljs$lang$applyTo = (function (seq26230){
var G__26231 = cljs.core.first.call(null,seq26230);
var seq26230__$1 = cljs.core.next.call(null,seq26230);
var G__26232 = cljs.core.first.call(null,seq26230__$1);
var seq26230__$2 = cljs.core.next.call(null,seq26230__$1);
var self__4816__auto__ = this;
return self__4816__auto__.cljs$core$IFn$_invoke$arity$variadic(G__26231,G__26232,seq26230__$2);
}));
...
var map__26237 = m;
var map__26237__$1 = cljs.core.__destructure_map.call(null,map__26237);
var file = cljs.core.get.call(null,map__26237__$1,new cljs.core.Keyword(null,"file","file",-1269645878));
var line = cljs.core.get.call(null,map__26237__$1,new cljs.core.Keyword(null,"line","line",212345235));
var column = cljs.core.get.call(null,map__26237__$1,new cljs.core.Keyword(null,"column","column",2078222095));
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1(cljs.core.reverse.call(null,cljs.core.map.call(null,(function (p1__26236_SHARP_){
return new cljs.core.Keyword(null,"name","name",1843675177).cljs$core$IFn$_invoke$arity$1(cljs.core.meta.call(null,p1__26236_SHARP_));
...
var temp__5720__auto___26238 = new cljs.core.Keyword(null,"message","message",-406056002).cljs$core$IFn$_invoke$arity$1(m);
if(cljs.core.truth_(temp__5720__auto___26238)){
var message_26239 = temp__5720__auto___26238;
cljs.core.println.call(null,message_26239);
} else {
}
...
var temp__5720__auto___26240 = new cljs.core.Keyword(null,"message","message",-406056002).cljs$core$IFn$_invoke$arity$1(m);
if(cljs.core.truth_(temp__5720__auto___26240)){
var message_26241 = temp__5720__auto___26240;
cljs.core.println.call(null,message_26241);
} else {
}
...
var output_dir__$1 = (function (){var G__26242 = output_dir;
if((!(clojure.string.ends_with_QMARK_.call(null,output_dir,"/")))){
return [G__26242,"/"].join('');
} else {
return G__26242;
}
})();
...
var G__26243 = exception.stack;
var G__26243__$1 = (((G__26243 == null))?null:clojure.string.split_lines.call(null,G__26243));
var G__26243__$2 = (((G__26243__$1 == null))?null:cljs.core.get.call(null,G__26243__$1,depth));
if((G__26243__$2 == null)){
return null;
} else {
return clojure.string.trim.call(null,G__26243__$2);
}
} else {
...
var vec__26244 = cljs.test.js_line_and_column.call(null,stack_element);
var line = cljs.core.nth.call(null,vec__26244,(0),null);
var column = cljs.core.nth.call(null,vec__26244,(1),null);
var vec__26247 = cljs.test.mapped_line_and_column.call(null,fname,line,column);
var fname__$1 = cljs.core.nth.call(null,vec__26247,(0),null);
var line__$1 = cljs.core.nth.call(null,vec__26247,(1),null);
var column__$1 = cljs.core.nth.call(null,vec__26247,(2),null);
...
var m__$1 = (function (){var G__26250 = new cljs.core.Keyword(null,"type","type",1174270348).cljs$core$IFn$_invoke$arity$1(m);
...
var G__26254 = (function (){var G__26253 = cljs.core.rest.call(null,fns);
...
return cljs.core.concat.call(null,obj,G__26253);
} else {
return G__26253;
}
})();
...
return cljs.core.vary_meta.call(null,G__26255,cljs.core.assoc,new cljs.core.Keyword("cljs.test","block?","cljs.test/block?",686379965),true);
}
});
...
var vec__26259 = fixtures_types.call(null);
var type = cljs.core.nth.call(null,vec__26259,(0),null);
var types = vec__26259;
...
return cljs.core.map.call(null,(function (p__26262){
var vec__26263 = p__26262;
var ns = cljs.core.nth.call(null,vec__26263,(0),null);
var vars__$1 = cljs.core.nth.call(null,vec__26263,(1),null);
return (function (){
...
var G__26266 = cljs.test.execution_strategy.call(null,once_fixtures,each_fixtures);
...
var seq__26267 = cljs.core.seq.call(null,vars__$1);
var chunk__26268 = null;
var count__26269 = (0);
var i__26270 = (0);
while(true){
if((i__26270 < count__26269)){
var v = cljs.core._nth.call(null,chunk__26268,i__26270);
var temp__5720__auto___26272 = new cljs.core.Keyword(null,"test","test",577538877).cljs$core$IFn$_invoke$arity$1(cljs.core.meta.call(null,v));
if(cljs.core.truth_(temp__5720__auto___26272)){
var t_26273 = temp__5720__auto___26272;
each_fixture_fn.call(null,((function (seq__26267,chunk__26268,count__26269,i__26270,t_26273,temp__5720__auto___26272,v,each_fixture_fn,G__26266,G__26266__$1,env,once_fixtures,each_fixtures,vec__26263,ns,vars__$1){
return (function (){
return cljs.test.run_block.call(null,cljs.test.test_var_block_STAR_.call(null,v,cljs.test.disable_async.call(null,t_26273)));
});})(seq__26267,chunk__26268,count__26269,i__26270,t_26273,temp__5720__auto___26272,v,each_fixture_fn,G__26266,G__26266__$1,env,once_fixtures,each_fixtures,vec__26263,ns,vars__$1))
);
} else {
}


var G__26274 = seq__26267;
var G__26275 = chunk__26268;
var G__26276 = count__26269;
var G__26277 = (i__26270 + (1));
seq__26267 = G__26274;
chunk__26268 = G__26275;
count__26269 = G__26276;
i__26270 = G__26277;
continue;
} else {
var temp__5720__auto__ = cljs.core.seq.call(null,seq__26267);
if(temp__5720__auto__){
var seq__26267__$1 = temp__5720__auto__;
if(cljs.core.chunked_seq_QMARK_.call(null,seq__26267__$1)){
var c__4649__auto__ = cljs.core.chunk_first.call(null,seq__26267__$1);
var G__26278 = cljs.core.chunk_rest.call(null,seq__26267__$1);
var G__26279 = c__4649__auto__;
var G__26280 = cljs.core.count.call(null,c__4649__auto__);
var G__26281 = (0);
seq__26267 = G__26278;
chunk__26268 = G__26279;
count__26269 = G__26280;
i__26270 = G__26281;
continue;
} else {
var v = cljs.core.first.call(null,seq__26267__$1);
var temp__5720__auto___26282__$1 = new cljs.core.Keyword(null,"test","test",577538877).cljs$core$IFn$_invoke$arity$1(cljs.core.meta.call(null,v));
if(cljs.core.truth_(temp__5720__auto___26282__$1)){
var t_26283 = temp__5720__auto___26282__$1;
each_fixture_fn.call(null,((function (seq__26267,chunk__26268,count__26269,i__26270,t_26283,temp__5720__auto___26282__$1,v,seq__26267__$1,temp__5720__auto__,each_fixture_fn,G__26266,G__26266__$1,env,once_fixtures,each_fixtures,vec__26263,ns,vars__$1){
return (function (){
return cljs.test.run_block.call(null,cljs.test.test_var_block_STAR_.call(null,v,cljs.test.disable_async.call(null,t_26283)));
});})(seq__26267,chunk__26268,count__26269,i__26270,t_26283,temp__5720__auto___26282__$1,v,seq__26267__$1,temp__5720__auto__,each_fixture_fn,G__26266,G__26266__$1,env,once_fixtures,each_fixtures,vec__26263,ns,vars__$1))
);
} else {
}


var G__26284 = cljs.core.next.call(null,seq__26267__$1);
var G__26285 = null;
var G__26286 = (0);
var G__26287 = (0);
seq__26267 = G__26284;
chunk__26268 = G__26285;
count__26269 = G__26286;
i__26270 = G__26287;
continue;
}
} else {
...
break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__26266__$1)].join('')));
