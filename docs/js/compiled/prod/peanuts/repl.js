...
peanuts.repl._register = (function (){var G__30318 = peanuts.repl.global$module$hljs_kit.Hljs;
G__30318.registerLanguage("clojure",peanuts.repl.global$module$hljs_kit.CljHljs);

G__30318.registerLanguage("clj",peanuts.repl.global$module$hljs_kit.CljHljs);
...
return cm.on("change",(function (p1__30319_SHARP_){
var val = p1__30319_SHARP_.getValue();
...
}catch (e30320){if((e30320 instanceof Error)){
var _e = e30320;
return null;
} else {
throw e30320;
...
return document.querySelectorAll("pre code").forEach((function (p1__30321_SHARP_){
return peanuts.repl.global$module$hljs_kit.Hljs.highlightBlock(p1__30321_SHARP_);
}));
});
...
return new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [re_catch.core.catch$,new cljs.core.PersistentVector(null, 4, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"div","div",1057191632),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"class","class",-2030961996),peanuts.styles.result_view_class.call(null)], null),new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"i.fas.fa-chevron-right","i.fas.fa-chevron-right",229921667)], null),(function (){var pred__30322 = cljs.core.apply;
var expr__30323 = new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [output], null);
if(cljs.core.truth_(pred__30322.call(null,peanuts.repl.hiccup_QMARK_,expr__30323))){
...
var _STAR_print_newline_STAR__orig_val__30325_30329 = cljs.core._STAR_print_newline_STAR_;
var _STAR_print_fn_STAR__orig_val__30326_30330 = cljs.core._STAR_print_fn_STAR_;
var _STAR_print_newline_STAR__temp_val__30327_30331 = true;
var _STAR_print_fn_STAR__temp_val__30328_30332 = (function (x__4761__auto__){
return sb__4760__auto__.append(x__4761__auto__);
});
(cljs.core._STAR_print_newline_STAR_ = _STAR_print_newline_STAR__temp_val__30327_30331);

(cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR__temp_val__30328_30332);

try{cljs.pprint.pprint.call(null,output);
}finally {(cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR__orig_val__30326_30330);

(cljs.core._STAR_print_newline_STAR_ = _STAR_print_newline_STAR__orig_val__30325_30329);
}
...
return new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"div","div",1057191632),(function (){var with_let30334 = reagent.ratom.with_let_values.call(null,new cljs.core.Keyword(null,"with-let30334","with-let30334",126507208));
var temp__5724__auto___30336 = reagent.ratom._STAR_ratom_context_STAR_;
if((temp__5724__auto___30336 == null)){
} else {
var c__12529__auto___30337 = temp__5724__auto___30336;
if((with_let30334.generation === c__12529__auto___30337.ratomGeneration)){
...
(with_let30334.generation = c__12529__auto___30337.ratomGeneration);
}


var init30335 = (with_let30334.length === (0));
var editor_STAR_ = ((init30335)?(with_let30334[(0)] = new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,">",">",-555517146),peanuts.repl.editor.call(null,new cljs.core.Keyword(null,"input-atom","input-atom",50965987).cljs$core$IFn$_invoke$arity$1(state),default_input),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"on-change","on-change",-732046149),(function (p1__30333_SHARP_){
return eval_fn.call(null,p1__30333_SHARP_,(function (o){
(this$.state.output = o);
