...
return cljs.core.into.call(null,cljs.core.PersistentArrayMap.EMPTY,cljs.core.remove.call(null,(function (p__23736){
...
if(((((cljs.core.set_QMARK_.call(null,class$)) || (cljs.core.sequential_QMARK_.call(null,class$)))) && (cljs.core.every_QMARK_.call(null,(function (p1__23740_SHARP_){
return (((p1__23740_SHARP_ instanceof cljs.core.Keyword)) || (typeof p1__23740_SHARP_ === 'string'));
}),class$)))){
...
return cljs.core.update_in.call(null,G__23741,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"class","class",-2030961996)], null),sablono.normalize.class$);
} else {
return G__23741;
}
});
...
var len__4829__auto___23744 = arguments.length;
var i__4830__auto___23745 = (0);
while(true){
if((i__4830__auto___23745 < len__4829__auto___23744)){
args__4835__auto__.push((arguments[i__4830__auto___23745]));

var G__23746 = (i__4830__auto___23745 + (1));
i__4830__auto___23745 = G__23746;
continue;
} else {
}
break;
...
var G__23743 = cljs.core.reduce.call(null,cljs.core.into,cljs.core.PersistentArrayMap.EMPTY,maps__$1);
if((!(cljs.core.empty_QMARK_.call(null,classes)))){
return cljs.core.assoc.call(null,G__23743,new cljs.core.Keyword(null,"class","class",-2030961996),cljs.core.vec.call(null,classes));
} else {
return G__23743;
}
} else {
...
/** @this {Function} */
(sablono.normalize.merge_with_class.cljs$lang$applyTo = (function (seq23742){
var self__4817__auto__ = this;
return self__4817__auto__.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq.call(null,seq23742));
}));
...
var vec__23749 = ((cljs.core.empty_QMARK_.call(null,matches))?(function(){throw cljs.core.ex_info.call(null,["Can't match CSS tag: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(s)].join(''),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"tag","tag",-1290361223),s], null))})():(cljs.core.truth_(new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 2, ["#",null,".",null], null), null).call(null,cljs.core.ffirst.call(null,matches)))?new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, ["div",matches], null):new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.first.call(null,matches),cljs.core.rest.call(null,matches)], null)
));
var tag_name = cljs.core.nth.call(null,vec__23749,(0),null);
var names = cljs.core.nth.call(null,vec__23749,(1),null);
return new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [tag_name,sablono.normalize.strip_css.call(null,cljs.core.some.call(null,(function (p1__23747_SHARP_){
if(cljs.core._EQ_.call(null,"#",cljs.core.first.call(null,p1__23747_SHARP_))){
return p1__23747_SHARP_;
} else {
return null;
}
}),names)),cljs.core.into.call(null,cljs.core.PersistentVector.EMPTY,cljs.core.comp.call(null,cljs.core.filter.call(null,(function (p1__23748_SHARP_){
return cljs.core._EQ_.call(null,".",cljs.core.first.call(null,p1__23748_SHARP_));
 ...
 */
sablono.normalize.element = (function sablono$normalize$element(p__23752){
var vec__23753 = p__23752;
var seq__23754 = cljs.core.seq.call(null,vec__23753);
var first__23755 = cljs.core.first.call(null,seq__23754);
var seq__23754__$1 = cljs.core.next.call(null,seq__23754);
var tag = first__23755;
var content = seq__23754__$1;
...
var vec__23756 = sablono.normalize.match_tag.call(null,tag);
var tag__$1 = cljs.core.nth.call(null,vec__23756,(0),null);
var id = cljs.core.nth.call(null,vec__23756,(1),null);
var class$ = cljs.core.nth.call(null,vec__23756,(2),null);
