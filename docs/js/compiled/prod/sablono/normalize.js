...
return cljs.core.into.call(null,cljs.core.PersistentArrayMap.EMPTY,cljs.core.remove.call(null,(function (p__24067){
var vec__24068 = p__24067;
var _ = cljs.core.nth.call(null,vec__24068,(0),null);
var v = cljs.core.nth.call(null,vec__24068,(1),null);
...
if(((((cljs.core.set_QMARK_.call(null,class$)) || (cljs.core.sequential_QMARK_.call(null,class$)))) && (cljs.core.every_QMARK_.call(null,(function (p1__24071_SHARP_){
return (((p1__24071_SHARP_ instanceof cljs.core.Keyword)) || (typeof p1__24071_SHARP_ === 'string'));
}),class$)))){
...
return cljs.core.update_in.call(null,G__24072,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"class","class",-2030961996)], null),sablono.normalize.class$);
} else {
return G__24072;
}
});
...
var len__4829__auto___24075 = arguments.length;
var i__4830__auto___24076 = (0);
while(true){
if((i__4830__auto___24076 < len__4829__auto___24075)){
args__4835__auto__.push((arguments[i__4830__auto___24076]));

var G__24077 = (i__4830__auto___24076 + (1));
i__4830__auto___24076 = G__24077;
continue;
} else {
}
break;
...
var G__24074 = cljs.core.reduce.call(null,cljs.core.into,cljs.core.PersistentArrayMap.EMPTY,maps__$1);
if((!(cljs.core.empty_QMARK_.call(null,classes)))){
return cljs.core.assoc.call(null,G__24074,new cljs.core.Keyword(null,"class","class",-2030961996),cljs.core.vec.call(null,classes));
} else {
return G__24074;
}
} else {
...
/** @this {Function} */
(sablono.normalize.merge_with_class.cljs$lang$applyTo = (function (seq24073){
var self__4817__auto__ = this;
return self__4817__auto__.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq.call(null,seq24073));
}));
...
var tag_name = cljs.core.nth.call(null,vec__24080,(0),null);
var names = cljs.core.nth.call(null,vec__24080,(1),null);
return new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [tag_name,sablono.normalize.strip_css.call(null,cljs.core.some.call(null,(function (p1__24078_SHARP_){
if(cljs.core._EQ_.call(null,"#",cljs.core.first.call(null,p1__24078_SHARP_))){
return p1__24078_SHARP_;
} else {
return null;
}
}),names)),cljs.core.into.call(null,cljs.core.PersistentVector.EMPTY,cljs.core.comp.call(null,cljs.core.filter.call(null,(function (p1__24079_SHARP_){
return cljs.core._EQ_.call(null,".",cljs.core.first.call(null,p1__24079_SHARP_));
 ...
 */
sablono.normalize.element = (function sablono$normalize$element(p__24083){
...
var tag = first__24086;
var content = seq__24085__$1;
...
var vec__24087 = sablono.normalize.match_tag.call(null,tag);
var tag__$1 = cljs.core.nth.call(null,vec__24087,(0),null);
var id = cljs.core.nth.call(null,vec__24087,(1),null);
var class$ = cljs.core.nth.call(null,vec__24087,(2),null);
